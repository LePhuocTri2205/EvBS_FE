    ...
    <footer className="bg-navy text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">EvBS</h3>
            <p className="text-gray-300">
              Hệ thống quản lý trạm đổi pin xe điện hiện đại, tiện lợi và nhanh chóng.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/service-plans" className="text-gray-300 hover:text-white">
                  Dịch vụ
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/stations" className="text-gray-300 hover:text-white">
                  Trạm đổi pin
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-gray-300 text-sm">
            &copy; {new Date().getFullYear()} EvBS. Bản quyền thuộc về Công ty Công nghệ EvBS.
          </p>
